...
namespace Cinema
{
    public static class DataWorker
    {
        ...
        public static Genre GetGenreById(int id)
        {
            using (ApplicationContext db = new ApplicationContext())
            {
                Genre genre = db.Genres.FirstOrDefault(st => st.id == id);
                return genre;
            }
        }
        ...
        public static hall GetHallById(int id)
        {
            using (ApplicationContext db = new ApplicationContext())
            {
                hall hall = db.halls.FirstOrDefault(dis => dis.id == id);
                return hall;
            }
        }
        ...
        public static session GetSessionById(int id)
        {
            using (ApplicationContext db = new ApplicationContext())
            {
                session Session = db.sessions.FirstOrDefault(grd => grd.id == id);
                return Session;
            }
        }
        ...
        public static Film GetFilmById(int id)
        {
            using (ApplicationContext db = new ApplicationContext())
            {
                Film Film = db.Films.FirstOrDefault(grp => grp.id == id);
                return Film;
            }
        }
